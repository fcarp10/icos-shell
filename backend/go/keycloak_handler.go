...
// Function to handle keycloak connections

func receiveAndValidateAccessToken(ctx context.Context, apiKey string) (ImplResponse, error) {
	...
	if !*rptResult.Active {
		...
		if err != nil {
			...
			if !*access_token_rptResult.Active {
				...
				return Response(201, "Keycloak check successful"), nil
			}
		}
	}
